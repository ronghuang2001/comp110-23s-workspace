...
def main() -> None:  # Define main function 
    """The entrypoint of the program and main game loop."""
    SECRET_WORD: str = "codes"
    # Set the secret word
    count: int = 1
    # Set a count varible to track how many turns the user has spent
    game: bool = True
    # Set a game variable
    while count <= 6 and game is True:  
        # To see how many turns the user has used and whether the user has won the game within 6 guesses
